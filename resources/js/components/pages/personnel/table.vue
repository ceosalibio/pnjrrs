<template>
    <div>
            ...
            <v-row v-if="Object.keys(obj).length > 0">
                <v-col cols="12" md="12" lg="12" xl="12">
                    <v-tabs  justify-center>
                        <v-tab @click="goTab('1')" >PERSONNEL QUALIFICATION RATING</v-tab>
                        <v-tab @click="goTab('2')" >PERSONNEL STRENGTH BY GRADE</v-tab>
                        <v-tab @click="goTab('3')" >PERSONNEL READINESS REPORT</v-tab>
                    </v-tabs>
                </v-col>
            </v-row>
        ...
        <!-- print excel -->
        <ExcelData ref="ExcelData"  :excelData="print"/>
    </div>
</template>
            ...
            generate(){
                ...
                axiosHttp.post('getPersonnel',{
                    ...
                    if(res.data == 'no'){
                        ...
                        personnel.details = this.obj
                        personnel.psgTable = personnel.getPsgTable(this.obj)
                        personnel.rating = this.obj.result
                        // this.tab3Rating(this.obj)
