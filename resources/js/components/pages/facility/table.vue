            ...
            <v-row v-if="Object.keys(obj).length > 0">
                <v-col cols="12" md="12" lg="12" xl="12">
                    <v-tabs  justify-center v-model="tab">
                        <v-tab href="#1" @click="goTab('1')" >FACILITY FILL-UP</v-tab>
                        <v-tab href="#2" @click="goTab('2')" >FACILITY  RAITING</v-tab>
                        <v-tab href="#3" @click="goTab('3')" >FACILITY READINESS REPORT</v-tab>
                    </v-tabs>
                </v-col>
            </v-row>
    ...
    export default {
        ...
        methods:{
            ...
            generate(){
                ...
                axiosHttp.post('getFacility',{
                    unit : data.unitCode,
                    month : this.nav.month,
                    name : this.user.name
                }).then((res)=>{
                    if(res.data == 'no'){
                        alert('No uploaded facility')
                    }else{
