            ...
            <v-row v-if="Object.keys(obj).length > 0">
                <v-col cols="12" md="12" lg="12" xl="12">
                    <v-tabs  justify-center v-model="tab">
                        <v-tab href="#1" @click="goTab('1')" >EQUIPMENT ITEM DETAILS</v-tab>
                        <v-tab href="#2" @click="goTab('2')" >EQUIPMENT READINESS REPORT</v-tab>
                    </v-tabs>
                </v-col>
            </v-row>
                ...
                axiosHttp.post('getEquipment',{
                    ...
                    if(res.data == 'no'){
                        ...
                        this.obj = {
                            ...
                            result : val.result,
                            master :val.master,
                            required1 : val.required1,
                            required2 : val.required2,
                            actual1 : val.actual1,
                            actual2 : val.actual2,
                            reason : val.reason,
                            status : val.status,
